...
class Transaksi_iuran_model extends CI_Model
{
    ...
    function get_by_id($id)
    {
        ...
        return $this->db->get('transaksi_iuran')->row();
    }
    ...
    function get_posisi_transaksi($id_akun)
    {
        //cek dulu periode di saldo akun transaksi yang mau di hapus apakah dalam masa berjalan apa sudah lewat laporan
