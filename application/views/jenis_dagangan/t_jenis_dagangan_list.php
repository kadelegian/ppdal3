    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row" style="margin-bottom: 10px">
                <div class="col-md-4">
                    <?php echo anchor(site_url('jenis_dagangan/create'), 'Create', 'class="btn btn-primary"'); ?>
                </div>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                <div class="btn-group" role="group">
                                    ...
                                    <a class="btn btn-primary" href='<?= base_url('jenis_dagangan/update/' . $jenis_dagangan->id) ?>'>Lihat</a>
                                    <a class="btn btn-danger" href='<?= base_url('jenis_dagangan/delete/' . $jenis_dagangan->id) ?>' onclick="javascript:return confirm('Apakah Anda Yakin Akan Menghapus data?')">Delete</a>
