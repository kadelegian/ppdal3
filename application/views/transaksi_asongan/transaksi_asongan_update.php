                ...
                <div class="card-body">
                    ...
                    <table>
                        <tr>
                            <td>Nomor Kartu</td>
                            <td>:</td>
                            <td><?= $data_pedagang->nomor ?></td>
                        </tr>
                        <tr>
                            <td>Nama Pedagang</td>
                            <td>:</td>
                            <td><?= $data_pedagang->nama_pedagang ?></td>
                        </tr>
                        <tr>
                            <td>Dagangan</td>
                            <td>:</td>
                                ...
                                <form id="form-update" action="<?= $action ?>" method="post">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="hidden" name="nama_pedagang" value="<?= $data_pedagang->nama_pedagang ?>">
                                            <input type="hidden" name="nomor_kartu" value="<?= $data_pedagang->nomor ?>">
                                    ...
                                    <div class="form-group">
                                        <label for="id_penjamin">Penjamin</label>
                                        <select class="form-control" id="id_penjamin" name="id_extra_charge">
                                            <?php foreach ($data_penjamin as $penjamin) : ?>
                                                <option value="<?= $penjamin->id ?>" <?= $data_pedagang->id_extra_charge == $penjamin->id ? 'selected' : '' ?>> <?= $penjamin->keterangan_charge . '(' . number_format($penjamin->extra_charge, 0, ',', '.') . ')' ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
