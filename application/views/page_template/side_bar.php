            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion d-print-none" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="<?= base_url('jenis_dagangan') ?>">Jenis Dagangan Pantai</a>
                            <a class="collapse-item" href="<?= base_url('jenis_dagangan_asongan') ?>">Jenis Dagangan Asongan</a>
